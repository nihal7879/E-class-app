...
export default function Topbar() {
  ...
  // Fetch the filter-aware 3-sheet Excel export as a blob so we can show a
  // loader while the server builds it (a plain <a download> gives no feedback,
  // and the report can take a few seconds). Guarded against double-clicks.
    ...
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between gap-2 border-b border-slate-200 bg-white px-3 sm:px-6">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
